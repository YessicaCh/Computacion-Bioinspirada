...
{
    public:
        CO(int maxit, double alpha, double beta, double ro, int nAnts, int b, double taumin, int q);
    ...
    private:
    const int nCiudades=10;//10 Ciudades A,B,C,D,E,F,G,H,I,J

    int nAnts , b , maxIt,Q; //Hormigas=Ants
...
CO::CO(int mi, double al, double be, double r, int nA, int nC, int elitismo, double tm, int q)
{
    nAnts = nA;
    b = elitismo;
    maxIt = mi;
